        ...
        {skillCategories.map((cat, idx) => (
          ...
          >
            <div className="flex items-center gap-4 border-b border-black/5 dark:border-white/5 pb-6">
              ...
              <h4 className="font-bold tracking-tight text-lg md:text-xl text-black dark:text-white">
                {cat.name}
              </h4>
            </div>
        ...
        >
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex gap-24 items-center">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.5em] text-gray-400 dark:text-gray-600 flex items-center gap-3">
                <Cpu size={16} className="text-accent-primary/60" />{" "}
                Sub-100ms Latency
              </span>
              <span className="text-[11px] font-black uppercase tracking-[0.5em] text-gray-400 dark:text-gray-600 flex items-center gap-3">
                <Cloud size={16} className="text-orange-500/60" /> Cloud Native
                Systems
              </span>
              <span className="text-[11px] font-black uppercase tracking-[0.5em] text-gray-400 dark:text-gray-600 flex items-center gap-3">
                <Bot size={16} className="text-purple-500/60" /> AI-First
                Architecture
              </span>
            </div>
          ))}
